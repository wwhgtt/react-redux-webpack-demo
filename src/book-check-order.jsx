...
const reducer = require('./reducer/book-check-order/index.js');
const BookCheckOrderApplication = require('./container/book-check-order/application.jsx');
