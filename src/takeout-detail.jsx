...
const reducer = require('./reducer/takeout-detail/index.js');
const TakeoutDetailApplication = require('./container/takeout-detail/application.jsx');
