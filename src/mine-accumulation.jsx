...
const reducer = require('./reducer/mine-accumulation/index.js');
const MineAccumulationApplication = require('./container/mine-accumulation/application.jsx');
