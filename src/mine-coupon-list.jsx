...
const reducer = require('./reducer/mine-coupon-list/index.js');
const MineCouponListApplication = require('./container/mine-coupon-list/application.jsx');
