...
const reducer = require('./reducer/register-validate/index.js');
const RegisterValidateApplication = require('./container/register-validate/application.jsx');
