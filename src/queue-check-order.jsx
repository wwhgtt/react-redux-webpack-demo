...
const reducer = require('./reducer/queue-check-order/index.js');
const QueueCheckOrderApplication = require('./container/queue-check-order/application.jsx');
