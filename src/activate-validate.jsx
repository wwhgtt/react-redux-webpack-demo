...
const reducer = require('./reducer/activate-validate/index.js');
const ActivateValidateApplication = require('./container/activate-validate/application.jsx');
