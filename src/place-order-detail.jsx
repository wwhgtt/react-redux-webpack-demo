...
const reducer = require('./reducer/place-order-detail/index.js');
const PlaceOrderDetailApplication = require('./container/place-order-detail/application.jsx');
