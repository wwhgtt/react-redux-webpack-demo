...
const reducer = require('./reducer/place-check-order/index.js');
const PlaceCheckOrderApplication = require('./container/place-check-order/application.jsx');
