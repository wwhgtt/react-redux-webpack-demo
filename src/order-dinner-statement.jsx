...
const reducer = require('./reducer/order-dinner-statement/index.js');
const OrderDinnerStateMentApplication = require('./container/order-dinner-statement/application.jsx');
...
ReactDOM.render(
  <Provider store={store}>
    <div>
      <OrderDinnerStateMentApplication />
    </div>
  </Provider>,
